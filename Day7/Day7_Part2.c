...
{
    int counter1 = 1, counter2 = 1,counter = 0, i = 0, j = 0, k = 0;
    char c;
    while (i < 5) {
        j = i + 1;
        counter = 1;
...
void change_letter(char **temp_hand) //Updated
{
    int i = 0, hand = 0;
    while (hand < HANDS) {
        i = 0;
...
int main() {
    FILE *f;
    int line = 0, tot_sum = 0, bid_res = 0, temp_value = 0;
    ...
    for (int i = 0; i < HANDS; i++) {
        ...
        printf("LINE: %d-----HAND VALUE: %d-----BID: %d\n", i, hand_value[i], bid[i]);    
    }
